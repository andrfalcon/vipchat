    ...
    return (
        <View style={{flex: 1, width: "100%"}}>
            ...
            <View style={{flex: 0.32, width:"100%"}}>
                <Button style={{ width:"100%", height: "33%", justifyContent: "center", borderRadius: 10, marginTop:"5%"  }} labelStyle={{ fontFamily: props.montserratSemiBold, fontSize: 17 }} mode="contained" buttonColor="#742DDD" onPress={() => handleSignUp()}>Join</Button>
