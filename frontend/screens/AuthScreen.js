...
const authScreen = (props) => {
    ...
    return (
        <View style={{flex: 0.77, width: "90%"}}>
            ...
            <Text style={{alignSelf: "center", fontFamily: props.spaceGrotesk, fontSize: 45, color:"white", paddingTop: "1.5%"}}>vipchat</Text>
            <AuthToggle montserrat={props.montserrat} onToggle={(selection) => handleAuth(selection)} auth={auth} />
            {(auth == "Sign Up") ? (
